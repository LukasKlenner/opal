...
object EagerFieldAccessAllocationSitePointsToBasedAliasAnalysisScheduler extends PointsToBasedAliasAnalysisScheduler
    ...
    override def createAnalysis(p: SomeProject): AllocationSitePointsToBasedAliasAnalysis =
        new AllocationSitePointsToBasedAliasAnalysis(p)

}

object EagerMethodInvocationAllocationSitePointsToBasedAliasAnalysisScheduler
    extends PointsToBasedAliasAnalysisScheduler
