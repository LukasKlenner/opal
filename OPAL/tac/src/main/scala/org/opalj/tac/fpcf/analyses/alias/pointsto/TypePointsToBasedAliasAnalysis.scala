...
import org.opalj.tac.fpcf.analyses.alias.EagerFieldAccessAliasAnalysisScheduler
import org.opalj.tac.fpcf.analyses.alias.EagerMethodInvocationAliasAnalysisScheduler
...
object EagerFieldAccessTypePointsToBasedAliasAnalysisScheduler extends PointsToBasedAliasAnalysisScheduler
    with EagerFieldAccessAliasAnalysisScheduler {

    override def createAnalysis(p: SomeProject): TypePointsToBasedAliasAnalysis = new TypePointsToBasedAliasAnalysis(p)

}

object EagerMethodInvocationTypePointsToBasedAliasAnalysisScheduler extends PointsToBasedAliasAnalysisScheduler
    with EagerMethodInvocationAliasAnalysisScheduler {
